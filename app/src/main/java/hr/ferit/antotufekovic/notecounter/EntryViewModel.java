...
public class EntryViewModel extends AndroidViewModel {
    ...
    public void update(Entry entry) {mRepository.update(entry);}
    public void incrementUpdate(Entry entry) {mRepository.incrementUpdate(entry);}
    public void decrementUpdate (Entry entry) {mRepository.decrementUpdate(entry);}
}
